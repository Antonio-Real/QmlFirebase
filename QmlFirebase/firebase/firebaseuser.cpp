...
/*!
    \qmlproperty string FirebaseUser::profession

    Optional field about the user's profession.
 */
QString FirebaseUser::profession() const
{
    return m_profession;
}

void FirebaseUser::setProfession(const QString &profession)
{
...
/*!
    \qmlproperty string FirebaseUser::birthdate

    Optional field about the user's birthdate.
 */
QString FirebaseUser::birthdate() const
{
    return m_birthdate;
}

void FirebaseUser::setBirthdate(const QString &birthdate)
{
